...
- 出現時は `quest-mr/assets/star-trek-tng-transporter.mp3`、消滅時は `quest-mr/assets/star-trek-transportation.mp3` を3D効果音として使います。
...
Enterprise風宇宙船とクリンゴン船の音声はWeb AudioのPannerNodeで3D化し、視点から遠ざかるほど小さくします。ただし遠距離でも完全には無音にならないよう、最低音量を残しています。
...
- Enterpriseとクリンゴン船の音声は、XR中はヘッド位置、PCプレビューではカメラ位置をWeb Audioのリスナーとして扱い、各船の現在位置へPannerNodeを追従させています。3D減衰経路とは別に小さな床音量経路を重ね、遠距離でも最低音量が残るようにしています。
