...
- 土星はリング付きで表示し、リングは完全な板ではなく、半径方向の濃淡・隙間・高密度の微細な粒子帯を重ねて表現しています。リングにも太陽方向の明暗と土星本体の影を反映します。周囲にはタイタン、レア、ディオネ、エンケラドゥス風の小衛星が公転します。
...
- 土星リングはCanvasTextureで半径方向の帯・Cassini風の隙間・粒状ノイズを生成し、さらに非発光のPoints微粒子を同じリング面に重ねています。リングと粒子はシェーダーで太陽方向の明暗と土星本体の影を計算します。
