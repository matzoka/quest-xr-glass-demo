...
- Enterpriseとクリンゴン船の音声は、XR中はヘッド位置、PCプレビューではカメラ位置をWeb Audioのリスナーとして扱い、各船の現在位置へPannerNodeを追従させています。クリンゴン船の出現 / 消滅効果音のような短い音も、再生中は船の位置へ追従します。3D減衰経路とは別に小さな床音量経路を重ね、遠距離でも最低音量が残るようにしています。
