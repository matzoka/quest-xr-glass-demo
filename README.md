...
地球はゆっくり自転し、雲のレイヤーが地表とは別の速度で流れます。さらに、人工衛星（ISS風）
が地球を周回し、USS エンタープライズ風の宇宙船が数分おきに画面を横切り（登場時にファン
ファーレが鳴ります）、ときおり流れ星が落ちて地表で発火し、地表ではランダムに稲光が光ります。月（大きさは地球の約1/4という実物どおりのサイズ比）が、地球の周りを周回します。さらに、東京とロサンゼルスを結ぶ小さな旅客機が地表を飛び交います。表示と物理（直線移動＋反射）は Three.js / WebXR
で動かしています。
