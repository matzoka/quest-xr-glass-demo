...
地球・月・惑星・天の川を眺めながら、USS Enterprise風宇宙船のワープ演出と、クリンゴン船のクローク解除風通過演出も楽しめるXR宇宙デモです。

Meta Quest 3 の VR / AR と、PC ブラウザの3Dプレビューで動く Three.js + WebXR デモです。
宇宙空間に浮かぶワイヤーフレームの部屋を舞台に、地球をコントローラーやキーボードで弾きながら、
月、惑星、太陽フレア、Apollo 11風ミッション、USS Enterprise風のワープ演出、
クリンゴン船のクローク解除風通過演出、小さな隕石、人工衛星、旅客機、彗星、夜景、
オーロラ、稲光などを眺められます。
...
遠景には巨大な天の川風の銀河面、星、淡い星雲、横長の銀河に加え、大小を混ぜた視認しやすい渦巻き銀河を20個、全球方向へ配置しています。
天の川は高解像度CanvasTextureで生成し、星粒の密集、暖色の銀河中心、暗いダストレーンを球面状の遠景リボンとして固定表示します。
強く見える範囲は約半周に抑え、反対側はかなり薄くして全天が同じ濃さにならないようにしています。
通常の遠景星は発光テクスチャを使わず、硬い点描画で表示してぼやけた発光球に見えないようにしています。
銀河や星雲の端は透明へフェードさせ、平面画像の四角い境界が見えにくいようにしています。
